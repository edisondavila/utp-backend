...
class AuthRepositoryImpl {
    validarCredenciales(usuario, contraseña) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { rows } = yield (0, db_1.query)('SELECT codigo, nombre, apePaterno, apeMaterno, correo, contrasena, rol FROM usuario WHERE correo = $1 AND contrasena = $2', [usuario, contraseña]);
